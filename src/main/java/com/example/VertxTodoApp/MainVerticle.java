...
public class MainVerticle extends AbstractVerticle {
  ...
  void deployAllVerticles(Promise<Void> start){
    ...
    MySQLConnectOptions connectOptions = new MySQLConnectOptions().setPort(333061).setHost("localhost").setDatabase("todo").setUser("user").setPassword("password");
    ...
    CompositeFuture.all(
      ...
      if (compositeFutureResult.succeeded()) {
        ...
        System.out.println("shite somthing is dead");
        System.exit(0);
      }
    });
  }
